...
public enum ServerPackets
{
    ...
    playerServerHealth,
    playerServerMana,
    playerServerCurrentExperience,
    playerServerMaxExperience,
    playerServerLevel,
    playerSetHPRegenMultiplier,
    playerSetMPRegenMultiplier,
    removeEnvironmentObj,
    spawnEnvironmentObj,
    registrationResult,
    responseClientSalt,
    responsePasswordCheck,
    sendInventoryToPlayer,
    sendLevelAndExperienceToPlayer,
    spawnEnemyShot,
}
...
public enum ClientPackets
{
    ...
    playerMana,
    registerPlayer,
    requestHPCrystalEffect,
    requestMPCrystalEffect,
    requestClientSaltForPlayer,
    requestPasswordCheck,
    requestInventory,
    moveItemFromSlotToSlot,
    requestLevelAndExperience,
}
